...

{
...

    {
        ...
        $wherekategorylembur=Kategori_lembur::where('jabatan_id',$wherepegawai->jabatan_id)->where('golongan_id',$wherepegawai->golongan_id)->first();
        ...
        $penggajian->tunjangan_pengambilan=Input::get('tunjangan_pegawai_id');
        ...
        $penggajian->save();
            ...
            $penggajian->jumlah_uang_lembur=$wherelemburpegawai->Jumlah_jam*$wherekategorylembur->besar_uang ;

            $penggajian->gaji_pokok=$wherejabatan->besar_uang+$wheregolongan->besar_uang;

            $penggajian->total_gaji=($wherelemburpegawai->Jumlah_jam*$wherekategorylembur->besar_uang)+($wheretunjangan->besar_uang)+($wherejabatan->besar_uang+$wheregolongan->besar_uang);
